...
pub use schema::{
    ...
    IdentityConfig, LarkConfig, MatrixConfig, MemoryConfig, MemoryPluginConfig, ModelRouteConfig,
    MultimodalConfig, NextcloudTalkConfig, ObservabilityConfig, OtpConfig, OtpMethod,
    PeripheralBoardConfig, PeripheralsConfig, PluginsConfig, ProxyConfig, ProxyScope,
